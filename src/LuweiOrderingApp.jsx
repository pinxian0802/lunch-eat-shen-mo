...
const DEFAULT_MENU = [
  // 豆腐/豆類 (Tofu)
  { id: '1', name: '豆干 (2個)', price: 10, category: 'Tofu' },
  { id: '2', name: '生豆皮 (1個)', price: 20, category: 'Tofu' },
  { id: '3', name: '豆皮 (1個)', price: 20, category: 'Tofu' },
  { id: '6', name: '素雞 (1個)', price: 15, category: 'Tofu' },
  { id: '7', name: '大豆干 (1個)', price: 20, category: 'Tofu' },
  { id: '8', name: '花干 (1個)', price: 20, category: 'Tofu' },
  { id: '13', name: '百頁豆腐 (1條)', price: 20, category: 'Tofu' },
  { id: '15', name: '麵腸 (1條)', price: 20, category: 'Tofu' },
  { id: '17', name: '百頁結 (2個)', price: 10, category: 'Tofu' },
  { id: '20', name: '素肚 (1個)', price: 25, category: 'Tofu' },
  { id: '38', name: '素腰花 (1個)', price: 5, category: 'Tofu' },
  
  // 蛋類 (Egg)
  { id: '4', name: '滷蛋 (1個)', price: 15, category: 'Egg' },
  { id: '16', name: '小鳥蛋 (3個)', price: 10, category: 'Egg' },

  // 蔬菜 (Veggie)
  { id: '5', name: '海帶 (1條)', price: 15, category: 'Veggie' },
  { id: '37', name: '杏鮑菇 (1兩)', price: 20, category: 'Veggie' },
  { id: '39', name: '蔬菜請自選', price: 30, category: 'Veggie' },

  // 丸類/特色 (Balls)
  { id: '9', name: '黑輪 (1個)', price: 10, category: 'Balls' },
  { id: '10', name: '甜不辣 (1片)', price: 10, category: 'Balls' },
  { id: '11', name: '豬血糕 (1條)', price: 15, category: 'Balls' },
  { id: '12', name: '花枝丸 (1個)', price: 10, category: 'Balls' },
  { id: '14', name: '水晶餃 (1個)', price: 5, category: 'Balls' },
  { id: '18', name: '貢丸 (1個)', price: 10, category: 'Balls' },
  { id: '19', name: '芋頭糕 (1個)', price: 20, category: 'Balls' },
  { id: '21', name: '福州丸 (1個)', price: 15, category: 'Balls' },

  // 肉類/內臟 (Meat)
  { id: '22', name: '雞肝 (1個)', price: 10, category: 'Meat' },
  { id: '23', name: '鵝心 (1個)', price: 10, category: 'Meat' },
  { id: '24', name: '豬皮 (1兩)', price: 15, category: 'Meat' },
  { id: '25', name: '腱子肉 (1兩)', price: 30, category: 'Meat' },
  { id: '26', name: '豬耳朵 (1兩)', price: 30, category: 'Meat' },
  { id: '27', name: '豬頭皮 (1兩)', price: 25, category: 'Meat' },
  { id: '28', name: '肝連 (1兩)', price: 30, category: 'Meat' },
  { id: '29', name: '嘴邊肉 (1兩)', price: 30, category: 'Meat' },
  { id: '30', name: '豬舌 (1兩)', price: 30, category: 'Meat' },
  { id: '31', name: '鴨翅 (1隻)', price: 30, category: 'Meat' },
  { id: '32', name: '雞翅 (1隻)', price: 40, category: 'Meat' },
  { id: '33', name: '大雞腳 (1隻)', price: 30, category: 'Meat' },
  { id: '34', name: '小雞腳 (2隻)', price: 15, category: 'Meat' },
  { id: '35', name: '雞腿 (1隻)', price: 90, category: 'Meat' },
  { id: '36', name: '鴨珍 (1個)', price: 35, category: 'Meat' },
];
